...
func (m *MockAuthorization) CreateUser(user Todo_api.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Create(userId int, list Todo_api.TodoList) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) GetAll(userId int) ([]Todo_api.TodoList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId)
	ret0, _ := ret[0].([]Todo_api.TodoList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTodoList) GetById(userId, listId int) (Todo_api.TodoList, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Update(userId, listId int, input Todo_api.UpdateListInput) error {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, item Todo_api.TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockTodoItem) GetAll(userId, listId int) ([]Todo_api.TodoItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId, listId)
	ret0, _ := ret[0].([]Todo_api.TodoItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetById mocks base method.
func (m *MockTodoItem) GetById(userId, itemId int) (Todo_api.TodoItem, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input Todo_api.UpdateItemInput) error {
	m.ctrl.T.Helper()
